...
/**
 * Python environment. Holds variables and evaluates expressions.
 *
 * @author masak
 * @author egonw
 */
public class PythonEnvironment implements ScriptingEnvironment {
    ...
    public final void reset() {
        ScriptEngineManager mgr
            = new ScriptEngineManager(PythonEnvironment.class.getClassLoader());
